...
namespace WebAutoJ
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int InsertUser(int? userID, string name, string login, string password, string avatar, string email, string sn_id, DateTime? fLD, string mS, string job, DateTime? bD, string gender, string hair, int? carID, string regNumber, string country, string brand, string model, string color)
        {
